...
export default function createContainer(
  Component,
  {fragments, initialVariables, versions, prepareVariables}
) {
  ...
  prepareVariables = prepareVariables || ((x) => x);
  ...
  class Container extends React.Component {
    ...
    shouldComponentUpdate(nextProps) {
      ...
      const shouldUpdate = nextHash !== this.prevHash;
    ...
    static getFragment(name, mapping, initVarsOverride = {}, parentContext) {
      ...
      const initVars = prepareVariables(_assign({}, initialVariables, initVarsOverride));
    ...
    static getQuery(initVarsOverride = {}) {
      ...
      return new QueryExecutor(fragments, initVars, Container);
    }
  }
